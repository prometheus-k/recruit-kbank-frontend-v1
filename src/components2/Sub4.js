    ...
    <div className="faqWrap">
      <div className="section-component ui-tab">
          ...
          <div className="tab-list ui-tab-nav">
            <ul className="tab-list-col" role="tablist">
              <li className="tab-item active">
                <a className="tab-link" href="#none" role="button">
        ...
        <div className="article-component">
          <div className="tab-content ui-tab-content active">
          ...
          <div className="tab-content ui-tab-content">
            <ul className="faq-list">
              <li>
