...
const faqData = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: '채용 메일(recruit@kbanknow.com)을 통해 변경 신청을 해주시면 수정 및 삭제를 도와드리고 있습니다.<br />단 지원서 접수기간이 마감된 이후에는 핸드폰 번호/ 이메일 주소만 수정이 가능합니다.'
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: '전형별 결과 발표까지 약 1~2주 정도 소요되며, 직무에 따라 최대 한달 정도의 기간이 소요될 수 있습니다.<br />혹시 한달이 지났는데, 결과 안내를 받지 못한 경우 채용 메일(recruit@kbanknow.com)을 통해 문의주시면 빠르게 도움드리겠습니다.'
      },
      {
    ...
    faqs: [
      {
        ...
        answer: '프로모션함이나 스팸메일함 확인 부탁드리며,</br> 확인되지 않을 경우 채용 메일(recruit@kbanknow.com)로 연락을 부탁드립니다.'
      },
      {
        question: '지원서 작성 시 오류가 발생하는 경우 어떻게 해야 하나요?',
        answer: '채용 메일(recruit@kbanknow.com)로 문의주시면 도움드리도록 하겠습니다.'
      }
    ]
  }
