...
const Sub1_view = () => {  
  ...
  return (
    ...
    <div>
  <div className="inner">
    <div className="titleWrap recruit">
      <p className="title1">프로덕트 디자이너</p>
  ...
  <div className="inner">
    ...
    <div className="pc">
      <div className="btnWrap appli">
        <button className="btn-appli-submit">
          <span className="txt">지원하기</span>
        </button>
        <button className="btn-appli-edit">
          <span className="txt">지원서 수정</span>
        </button>
      </div>
    </div>
    {/*//pc 용*/}
    ...
    <div className="m">
      <div className="btnWrap appli">
        <button className="btn-appli-submit">
          <span className="txt">지원서 작성은 PC를 이용해주세요!</span>
        </button>
        <button className="btn-appli-edit">
          <span className="txt">지원서 수정은 PC를 이용해주세요!</span>
        </button>
      </div>
    </div>
    {/*//mobile 용*/}
